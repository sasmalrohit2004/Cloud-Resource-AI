...
export default function Navigation({
  ...
  const navItems = [
    { id: 'dashboard', label: 'Dashboard', icon: FiActivity, count: 'Live' },
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.count && (
                    <span className="hidden md:inline-block px-1.5 py-0.2 rounded-full text-[10px] font-semibold bg-emerald-100 text-emerald-700">
                      {item.count}
                    </span>
                  )}
                </button>
